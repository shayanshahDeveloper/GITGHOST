...
const HowItWorks = ({ theme, setTheme }) => (
    <PageTemplate title="How It Works" theme={theme} setTheme={setTheme}>
        ...
        <div className="space-y-16 mt-4">
            <div className="flex flex-col gap-3">
                <h3 className="text-main font-bold text-lg tracking-tight">1. The Master Dashboard</h3>
            ...
            <div className="flex flex-col gap-3">
                <h3 className="text-main font-bold text-lg tracking-tight">2. Repository Management</h3>
            ...
            <div className="flex flex-col gap-3">
                <h3 className="text-main font-bold text-lg tracking-tight">3. Precision Scheduling</h3>
            ...
            <div className="flex flex-col gap-3">
                <h3 className="text-main font-bold text-lg tracking-tight">4. Real-time Analytics</h3>
            ...
            <div className="flex flex-col gap-3">
                <h3 className="text-main font-bold text-lg tracking-tight">5. Seamless Authentication</h3>
